        ...
        <div className="relative h-full pt-20 md:pt-0 md:h-[80vh] min-h-[600px] w-full">
            ...
            <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end pb-5">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-indigo-600 to-teal-400 bg-clip-text text-transparent animate-fade-in">
                ...
                <div className="text-center mt-6">
                    <p className="text-gray-300 mb-2">Recent Search Query:</p>
